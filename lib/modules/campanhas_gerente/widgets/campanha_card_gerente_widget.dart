...
class CampanhaCardGerenteWidget extends StatelessWidget {
  ...
  const CampanhaCardGerenteWidget({
    super.key,
        ...
        children: [
            ...
            details: [
              ...
              _DetailRow(
                ...
                value: UtilBrasilFields.obterReal(
                  campanha.bonificacaoIndividual,
                ),
              ),
              _DetailRow(
                label: 'Vendas',
          ...
          _PerformanceSection(
            ...
            details: [
              ...
              _DetailRow(
                label: 'Valor por meta',
                value: UtilBrasilFields.obterReal(campanha.bonificacaoGerente),
              ),
              _DetailRow(
                label: 'Vendas',
                value:
              ...
              _DetailRow(
                label: 'Premiação conquistada',
                value: UtilBrasilFields.obterReal(
                  campanha.bonificacaoGerenteConquistada,
                ),
                bold: true,
              ),
            ],
