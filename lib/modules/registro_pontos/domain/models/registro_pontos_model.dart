...
class RegistroPontoModel {
  ...
  factory RegistroPontoModel.empty() {
  ...
  factory RegistroPontoModel.fromMap(Map<String, dynamic> map) {
    return RegistroPontoModel(
  ...
  factory RegistroPontoModel.fromJson(String source) =>
      RegistroPontoModel.fromMap(json.decode(source));
}
