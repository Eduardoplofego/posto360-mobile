...
class CardChamadosWidget extends StatelessWidget {
  final VoidCallback? onPressed;

  const CardChamadosWidget({super.key, this.onPressed});
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Comunicação entre escritório e filiais',
                      style: TextStyle(
                        fontSize: 12,
