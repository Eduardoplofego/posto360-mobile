...
import 'package:posto360/modules/equipe/widgets/card_resumo_equipe_widget.dart';
import 'dash_gerente_controller.dart';

class DashGerentePage extends GetView<DashGerenteController> {
  const DashGerentePage({super.key});
                        ...
                        if (controller.loadingResumoEquipe ||
                          ...
                          CardLoadingWidget(
                            ...
                            child: CardResumoEquipeWidget(
                              ...
                              onPressed: () {
                                Get.toNamed(
                                  '/equipe/${controller.monthSelected.toIso8601String()}',
                                );
                              },
                            ),
                          ),
