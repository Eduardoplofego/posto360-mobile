...
class DashGerenteBindings implements Bindings {
  @override
  void dependencies() {
    ...
    final controller = DashGerenteController(equipeService: Get.find());
    Get.put<DashGerenteController>(controller);
    Get.put<DashController>(controller);
  }
}
